...
The process of creating a website using HTML, CSS, and JavaScript can be both challenging and rewarding. It requires a combination of technical skills and creative vision to bring a website to life. Our group had to work together closely to ensure that we met our goals for the website and produced a high-quality product.

One of the essential elements of our aircraft emergency landing website was the design aesthetic. We wanted to create a website that was both modern and sleek, while still being functional and easy to navigate. We used different design techniques to achieve this, such as using a minimalist color scheme, clean typography, and strategic use of negative space.

Another critical aspect of our website was the user experience. We wanted to ensure that visitors to the site could find the information they needed quickly and easily. To achieve this, we made sure that the menu was well-organized, with clear labels and descriptions. We also incorporated interactive features, such as the flipping title and hamburger dropdown menu effect, to add a bit of visual interest to the site.

Creating the animations and interactions on the website was one of the most challenging aspects of the project. We had to experiment with different techniques and adjust the timing and duration of the animations to ensure that they looked and functioned correctly. We also had to make sure that the animations didn't slow down the loading time of the site, as this can negatively impact the user experience.

Another significant challenge that we faced when creating our aircraft emergency landing website was making the website responsive. A responsive website means that the website layout adjusts according to the screen size of the device being used. This ensures that the website is easy to use and read, regardless of whether the user is on a desktop computer, tablet, or mobile phone. It was very time-consuming and difficult to implement so we chose not to. Also, it was not part of the grading requirements. 

Despite the challenges, creating the aircraft emergency landing website was a fulfilling experience for our group. We learned a lot about web design and development, from technical skills to design aesthetics and user experience. We also developed our teamwork and communication skills, as we had to work together closely to ensure that we met our goals for the project.

## Video Creation

The idea behind the video being displayed is that it would be a complementary viewing that only serves to enhance the experience of the user listening to the audio. While it does not add to the storyline, it adds to the experience of going through a harrowing experience while being around 30,000 feet in the air, as the user can see the clouds causing their severe turbulence, and can see exactly how the change of the weather is affecting their flight. Finally, the user can also see how the clouds clear up as the captain takes a different route that ultimately saves their lives.
...
This project had various stages in the process of creation starting from brainstorming, storyline creation, and script to finding sound effects, recording sounds, editing sounds together to fit the theme, and website creation to depict the story of the soundscape. We started with creating the soundscape which helped us reach our final outcome. Listening to sound effects and recording them helped us design the website effectively and efficiently in the best way to represent the soundscape. In this project, we devoted the majority of our time and effort to the soundscape in order to ensure we develop a clear, engaging, and entertaining soundscape for our audience. Creating this soundscape definitely had its ups and downs. As a group, we tested and listened to our soundscape a few times and went back to fine-tune certain things in the audio to ensure we have a good quality experience for our audience. Overall, we believe our expectations and goals were met, and we were able to execute the soundscape we had in mind as well as the vision of our website to correspond with and host our soundscape.  
